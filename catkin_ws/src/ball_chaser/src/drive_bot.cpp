...
bool handle_drive_request(ball_chaser::DriveToTarget::Request& req, 
    ...
    ROS_INFO(" handle_drive_request : request received - linear_x : %f, angular_z: %f",
    ...
    res.msg_feedback = " Setting linear_x: "+ std::to_string((float)motor_command.linear.x)+
                        ", angular_z: "+std::to_string((float)motor_command.angular.z);
